...
2. Register it to a YMCDataLoader (see [Guide: Your first static item](./your-first-item.md) if you don't know how to do this)
...
1. **Bench Item Key**: the item key of where this recipe will be available at
	...
	- Use `@npc:<npc_name>` when it is a craft performed by a NPC. `<npc_name>` is the constant from Yotan Mod Core.
