...
3. Drag and drop the `YotanModCoreDefinitions.dll` file into your unity project Plugins folder
...
> [!WARNING]
> DON'T drag and drop the `YotanModCoreDefinitions.dll` file, it will cause issues.
...
3. Copy your newly dowloaded `YotanModCoreDefinitions.dll` into it, and accept replacing the old one
...
Check the guides on the main readme.
